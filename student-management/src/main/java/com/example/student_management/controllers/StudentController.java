...
@Tag(name = "Gestion des étudiants", description = "Endpoints pour gérer les étudiants")
public class StudentController {
    ...
    @GetMapping("/all")
    @Operation(summary = "Liste tous les étudiants", description = "Retourne la liste complète des étudiants")
